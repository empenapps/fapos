        ...
        {({
          ...
          <Form>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <Stack spacing={1}>
                  ...
                  <OutlinedInput
                    fullWidth
                    error={Boolean(
                      touched.inProductCode && errors.inProductCode
                    )}
                    id="inProductCode"
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  <InputLabel htmlFor="inProductNameEn">
                    Product Description
                  </InputLabel>
                  <OutlinedInput
                    fullWidth
                    error={Boolean(
                      touched.inProductNameEn && errors.inProductNameEn
                    )}
                    id="inProductNameEn"
              ...
              <Grid item xs={12}>
                <Stack spacing={1}>
                  <InputLabel htmlFor="inProductPrice">
                    Price Per Quantity
                  </InputLabel>
                  <OutlinedInput
                    fullWidth
                    error={Boolean(
                      touched.inProductPrice && errors.inProductPrice
                    )}
                    id="inProductPrice"
